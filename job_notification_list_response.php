...
<?php
	...
	if( !empty($params['search']['value']) ) {   
		...
		$where .=" OR CAST(Q.jobinfoid AS text) LIKE '%".$params['search']['value']."%' ";  
	...
	$sql = "SELECT Q.notifymasterid,U.firstname,Q.jobinfoid,Q.title,Q.message,Q.url,Q.notifiedon,G.userid FROM notifymaster as Q LEFT OUTER JOIN gennotifyalloc as G ON Q.notifymasterid = G.notifymasterid JOIN userinfo as U ON G.userid = U.userid WHERE Q.jobinfoid is NOT NULL";
	$sqlTot .= $sql;
	$sqlRec .= $sql;
